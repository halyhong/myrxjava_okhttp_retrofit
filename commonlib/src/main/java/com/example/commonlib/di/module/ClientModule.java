package com.example.commonlib.di.module;
...
import com.example.commonlib.http.GlobeHttpHandler;
import com.example.commonlib.http.RequestIntercept;
import com.example.commonlib.rx.rxerrorhandler.ResponseErrorListener;
import com.example.commonlib.rx.rxerrorhandler.RxErrorHandler;
import com.example.commonlib.utils.SpUtil;
...
public class ClientModule {
    ...
    private static RxPermissions rxPerSingleton;

    @Singleton
    @Provides
    synchronized RxPermissions provideRxPermissions(Activity act) {
        if (null == rxPerSingleton) {
            rxPerSingleton = new RxPermissions(act);
        }
        return rxPerSingleton;
    }
    /**
     * @param builder
     * @param client
